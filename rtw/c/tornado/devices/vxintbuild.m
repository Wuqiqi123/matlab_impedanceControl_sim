...
%   In simulation mode the input of the interrupt handler S-function
%   is connected to the output of a trigger port block.  In code generation mode the
...
if numIRQs == 0 
  errTxt = 'Must specify at least 1 interrupt.';
  return
elseif numOffsets == 0
  errTxt = 'Must specify at least 1 interrupt vector offset.';
  return
...
% configured for code generation and it's now configured for simulation
...
% configured for simulation and now it's configured for code generation
