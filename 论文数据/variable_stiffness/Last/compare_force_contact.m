...
set(Ax(1),'ylim',[-0.05 0.3]) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YLim',[-50 300],'YColor','magenta') % handles可以指定具体坐标轴的句柄
%set(h1,'XTick',0:1:10) % handles可以指定具体坐标轴的句柄
set(Ax(1),'YTick',-0.05:0.05:0.3) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YTick',-50:50:300) % handles可以指定具体坐标轴的句柄
