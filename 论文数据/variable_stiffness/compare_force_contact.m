...
set(Ax(1),'ylim',[0 0.2]) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YLim',[0 50],'YColor','magenta') % handles可以指定具体坐标轴的句柄
%set(h1,'XTick',0:1:10) % handles可以指定具体坐标轴的句柄
set(Ax(1),'YTick',0:0.05:0.2) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YTick',0:10:50) % handles可以指定具体坐标轴的句柄
