...
set(Ax(1),'ylim',[-0.1 0.8]) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YLim',[-50 400],'YColor','magenta') % handles可以指定具体坐标轴的句柄
%set(h1,'XTick',0:1:10) % handles可以指定具体坐标轴的句柄
set(Ax(1),'YTick',-0.1:0.1:0.8) % handles可以指定具体坐标轴的句柄
set(Ax(2),'YTick',-50:50:400) % handles可以指定具体坐标轴的句柄
...
k1=legend('期望位置Xdx','期望位置Xdy','期望位置Xdz','实际位置Xx','实际位置Xy','实际位置Xz','接触力Fy','接触力Fz','fontsize',16);
